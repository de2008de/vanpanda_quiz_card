...
INSERT INTO concept_cards (id, term, definition) VALUES (9, 'Cost', 'The economics term cost, also known as economic cost or opportunity cost, refers to the potential gain that is lost by foregoing one opportunity in order to take advantage of another. The lost potential gain is the cost of the opportunity that is accepted.');
INSERT INTO concept_cards (id, term, definition) VALUES (10, 'Government spending', 'Economists distinguish between government spending on newly produced goods and services, such as paying a company to build a new highway, and government spending on transfer payments, which are payments such as welfare payments intended to redistribute income.');
